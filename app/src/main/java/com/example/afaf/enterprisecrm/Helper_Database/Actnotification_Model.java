...
public class Actnotification_Model {
    private int id;
    ...
    public Actnotification_Model() {
    }

    public Actnotification_Model(int id, String notifSubject, String notifDesc, String notifSentFlag, String notifID, String updatedDate, String createdDate) {
        this.id = id;
