...
public class lead_cases_adapter extends ArrayAdapter<casesModel> {
    protected Context mContext;
    protected List<casesModel> mCases;

    public  static boolean tabbedcaselead = false;

    String lid;
    String lidname;


    public lead_cases_adapter(Context context, List<casesModel> cases, JCGSQLiteHelper_cases db) {
...
//       JCGSQLiteHelper_Leads lead = new JCGSQLiteHelper_Leads(mContext);
//        String name =   lead.getLeadWithId(casesModel.getCaseRelatedLead()).get(0).getCommertialName()+"";
//        holder.casesRelatedLead.setText(name);
